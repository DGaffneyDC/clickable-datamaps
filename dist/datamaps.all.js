(function(root) {
  ...
  var defaultOptions = {
    ...
    geographyConfig: {
        ...
        highlightFillColor: '#F50057',
        highlightBorderColor: '#673AB7',
        highlightBorderWidth: 2,
        highlightBorderOpacity: 1,
        clickBackgroundColor:'rgb(245,0,87)',
        clickBorderColor: 'rgb(103,58,183)',
        clickBorderWidth: 3,
        clickBorderOpacity: 1
    },
    projectionConfig: {
      rotation: [97, 0]
    },
    ...
    if ( options.highlightOnHover || options.popupOnHover ) {
      svg.selectAll('.datamaps-subunit')
       ...
       .on('click', function (datum) {
          ...
          if ($this.attr('selected') == null || $this.attr('selected') == 'false'){
            isSelected = 'true';
            svg.selectAll('.datamaps-subunit')
              .style('stroke', "#673AB7")
          ...
          if (options.highlightOnClick && $this.attr('selected') == 'true') {
            ...
            $this
              .style('stroke', val(datum.clickBorderColor, options.clickBorderColor, datum))
              .style('stroke-width', val(datum.clickBorderWidth, options.clickBorderWidth, datum))
              .style('stroke-opacity', val(datum.clickBorderOpacity, options.clickBorderOpacity, datum))
              .style('fill-opacity', val(datum.highlightFillOpacity, options.highlightFillOpacity, datum))
              .attr('data-previousAttributes', JSON.stringify(previousAttributes));
          ...
          } else if (options.highlightOnClick && $this.attr('selected') == 'false') {
            // Reapply previous attributes
            var previousAttributes = JSON.parse( $this.attr('data-previousAttributes') );
            for ( var attr in previousAttributes ) {
              $this.style(attr, previousAttributes[attr]);
